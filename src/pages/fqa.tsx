...
import { Input } from "components/forms/send-email/Form.styles";
  ...
  return (
    <div style={Style}>
      <div style={Style1}>
        ...
        <span>
          Um compilado das perguntas que temos recebido com mais frequência. Se
          a tua pergunta não está a qui listada, não te preocupes tu podes
